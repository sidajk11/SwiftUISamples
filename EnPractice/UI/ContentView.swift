...
extension ContentView {
    ...
    @ViewBuilder func view(for route: Route) -> some View {
        ...
        case .login:
            LoginView(viewModel: .init(dependency: .init(container: .defaultValue)))
...
struct ContentView: View {
    ...
    @FetchRequest(
        ...
        animation: .default)
    private var items: FetchedResults<ItemDM>
...
#Preview {
    ContentView(viewModel: ContentView.ViewModdel(dependency: .preview))
